...
type ComplexityRoot struct {
	Mutation struct {
		SignUp func(childComplexity int, input *internal.SignUpInput) int
	}
...
type MutationResolver interface {
	SignUp(ctx context.Context, input *internal.SignUpInput) (*internal.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.signUp":
		...
		return e.complexity.Mutation.SignUp(childComplexity, args["input"].(*internal.SignUpInput)), true
...
var sources = []*ast.Source{
	{Name: "../../auth/auth.graphql", Input: `# directive @auth
...
func (ec *executionContext) field_Mutation_signUp_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 *internal.SignUpInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalOSignUpInput2ᚖgithubᚗcomᚋpulkitbhardwajᚋmatrixᚋinternalᚐSignUpInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_signUp(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().SignUp(rctx, fc.Args["input"].(*internal.SignUpInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputSignUpInput(ctx context.Context, obj interface{}) (internal.SignUpInput, error) {
	var it internal.SignUpInput
...
func (ec *executionContext) unmarshalOSignUpInput2ᚖgithubᚗcomᚋpulkitbhardwajᚋmatrixᚋinternalᚐSignUpInput(ctx context.Context, v interface{}) (*internal.SignUpInput, error) {
	if v == nil {
		return nil, nil
	}
